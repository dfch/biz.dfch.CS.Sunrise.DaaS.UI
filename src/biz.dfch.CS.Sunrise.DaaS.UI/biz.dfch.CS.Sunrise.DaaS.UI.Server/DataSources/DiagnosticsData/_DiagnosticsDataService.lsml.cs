...
{
    public partial class DiagnosticsDataService
    {
        ...
        partial void DiagnosticsData_SendingRequest(ODataSendingState state)
        {
        ...
        partial void DiagnosticsData_ReceivedResponse(ODataReceivedState state)
        {
