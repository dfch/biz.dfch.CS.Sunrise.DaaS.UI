...
(function (lightSwitchApplication) {
    ...
    function AuditTrail(entitySet) {
        /// <summary>
        /// Represents the AuditTrail entity type.
        /// </summary>
        /// <param name="entitySet" type="msls.EntitySet" optional="true">
        /// The entity set that should contain this auditTrail.
        /// </param>
        /// <field name="EntityId" type="String">
        /// Gets or sets the entityId for this auditTrail.
        /// </field>
        /// <field name="EntityType" type="String">
        /// Gets or sets the entityType for this auditTrail.
        /// </field>
        /// <field name="EntityState" type="String">
        /// Gets or sets the entityState for this auditTrail.
        /// </field>
        /// <field name="Original" type="String">
        /// Gets or sets the original for this auditTrail.
        /// </field>
        /// <field name="Current" type="String">
        /// Gets or sets the current for this auditTrail.
        /// </field>
        /// <field name="Id" type="String">
        /// Gets or sets the id for this auditTrail.
        /// </field>
        /// <field name="Tid" type="String">
        /// Gets or sets the tid for this auditTrail.
        /// </field>
        /// <field name="Name" type="String">
        /// Gets or sets the name for this auditTrail.
        /// </field>
        /// <field name="Description" type="String">
        /// Gets or sets the description for this auditTrail.
        /// </field>
        /// <field name="CreatedBy" type="String">
        /// Gets or sets the createdBy for this auditTrail.
        /// </field>
        /// <field name="ModifiedBy" type="String">
        /// Gets or sets the modifiedBy for this auditTrail.
        /// </field>
        /// <field name="Created" type="Date">
        /// Gets or sets the created for this auditTrail.
        /// </field>
        /// <field name="Modified" type="Date">
        /// Gets or sets the modified for this auditTrail.
        /// </field>
        /// <field name="RowVersion" type="String">
        /// Gets or sets the rowVersion for this auditTrail.
        /// </field>
        /// <field name="details" type="msls.application.AuditTrail.Details">
        /// Gets the details for this auditTrail.
        /// </field>
    ...
    function DiagnosticsData(dataWorkspace) {
        ...
        /// </param>
        /// <field name="AuditTrails" type="msls.EntitySet">
        /// Gets the AuditTrails entity set.
        /// </field>
    ...
    msls._addToNamespace("msls.application", {
        ...
        AuditTrail: $defineEntity(AuditTrail, [
            { name: "EntityId", type: String },
            { name: "EntityType", type: String },
            { name: "EntityState", type: String },
        ...
        DiagnosticsData: $defineDataService(DiagnosticsData, lightSwitchApplication.rootUri + "/DiagnosticsData.svc", [
            { name: "AuditTrails", elementType: AuditTrail },
            { name: "Endpoints", elementType: Endpoint }
        ], [
            {
                name: "AuditTrails_SingleOrDefault", value: function (Id) {
                    return new $DataServiceQuery({ _entitySet: this.AuditTrails },
                        lightSwitchApplication.rootUri + "/DiagnosticsData.svc" + "/AuditTrails(" + "Id=" + $toODataString(Id, "Int64?") + ")"
                    );
                }
            },
            {
